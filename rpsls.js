...
function pickRock() {
  ...
  if (computerChoice === options[0]) {
    ...
    hTwo.innerText = `You lose! ${options[1]} covers ${options[0]}.`;
  } else if (computerChoice === options[2]) {
    hTwo.innerText = `You win! ${options[0]} crushes ${options[2]}.`;
  } else if (computerChoice === options[3]) {
    hTwo.innerText = `You win! ${options[0]} crushes ${options[3]}.`;
  } else {
    hTwo.innerText = `You lose! ${options[4]} vaporizes ${options[0]}.`;
  };
...
function pickPaper() {
  ...
  computerChooses();
    ...
    if (computerChoice === options[0]) {
      hTwo.innerText = `You win! ${options[1]} covers ${options[0]}.`;
    } else if (computerChoice === options[1]) {
      hTwo.innerText = `It is a tie! Computer and player both chose ${computerChoice}.`;
    } else if (computerChoice === options[2]) {
      hTwo.innerText = `You lose! ${options[2]} cuts ${options[1]}.`;
    } else if (computerChoice === options[3]) {
      hTwo.innerText = `You lose! ${options[3]} eats ${options[1]}.`;
    } else {
      hTwo.innerText = `You win! ${options[1]} disproves ${options[4]}.`;
    };
  hOne.appendChild(hTwo);
};
function pickScissors() {
  ...
  if (computerChoice === options[0]) {
    hTwo.innerText = `You lose! ${options[0]} crushes ${options[2]}.`;
  } else if (computerChoice === options[1]) {
    hTwo.innerText = `You win! ${options[2]} cuts ${options[1]}.`;
  } else if (computerChoice === options[2]) {
    hTwo.innerText = `It is a tie! Computer and player both chose ${computerChoice}.`;
  } else if (computerChoice === options[3]) {
    hTwo.innerText = `You win! ${options[2]} decapitates ${options[3]}.`;
  } else {
    hTwo.innerText = `You lose! ${options[4]} smashes ${options[2]}.`;
  };
  hOne.appendChild(hTwo);
};
...
function pickLizard() {
  ...
  if (computerChoice === options[0]) {
    hTwo.innerText = `You lose! ${options[0]} crushes ${options[3]}.`;
  } else if (computerChoice === options[1]) {
    hTwo.innerText = `You win! ${options[3]} eats ${options[1]}.`;
  } else if (computerChoice === options[2]) {
    hTwo.innerText = `You lose! ${options[2]} decapitates ${options[3]}.`;
  } else if (computerChoice === options[3]) {
    hTwo.innerText = `It is a tie! Computer and player both chose ${computerChoice}.`;
  } else {
    hTwo.innerText = `You win! ${options[3]} poisons ${options[4]}.`;
  };
  hOne.appendChild(hTwo);
};
...
function pickSpock() {
  ...
  if (computerChoice === options[0]) {
    hTwo.innerText = `You win! ${options[4]} vaporizes ${options[0]}.`;
  } else if (computerChoice === options[1]) {
    hTwo.innerText = `You lose! ${options[1]} disproves ${options[4]}.`;
  } else if (computerChoice === options[2]) {
    hTwo.innerText = `You win! ${options[4]} smashes ${options[2]}.`;
  } else if (computerChoice === options[3]) {
    hTwo.innerText = `You lose! ${options[3]} poisons ${options[4]}.`;
  } else {
    hTwo.innerText = `It is a tie! Computer and player both chose ${computerChoice}.`;
